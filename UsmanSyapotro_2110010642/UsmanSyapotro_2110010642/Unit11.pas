...
if e_1.Text='' then
  begin
    ...
    if e_3.text=''then
    begin
     ShowMessage('KTP DIISI DENGAN BENAR');
    end else
    if e_4.text=''then
    begin
    ShowMessage('SLIP GAJI BELUM SESUAI');
    end else
    if e_5.text=''then
    begin
     ShowMessage('KARTU KELUARGA BELUM SESUAI');
     end else
    if e_6.text=''then
    begin
    ...
    if e_7.text=''then
    begin
     ShowMessage('BUKU NIKAH DIISI DENGAN BENAR');
    end else
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tbl_syarat_pemesanan_rmh values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'","'+e_6.Text+'","'+e_7.Text+'")');
 zqry1.ExecSQL ;

 zqry1.SQL.Clear;
 zqry1.SQL.Add('select * from tbl_syarat_pemesanan_rmh');
 zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_syarat_pemesanan_rmh set id_kustomer="'+e_2.Text+'",ktp="'+e_3.Text+'",slip_gaji="'+e_4.Text+'",kk="'+e_5.Text+'",npwp="'+e_6.Text+'",buku_nikah= "'+e_7.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_syarat_pemesanan_rmh where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_syarat_pemesanan_rmh');
zqry1.Open;
