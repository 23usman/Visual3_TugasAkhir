...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('NAMA PEMOHON BELUM DIISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
     ShowMessage('PEKERJAAN DIISI DENGAN BENAR');
    end else
    if e_4.text=''then
    begin
    ...
    if e_5.text=''then
    begin
     ShowMessage('STATUS PENGAJUAN BELUM SESUAI');
     end else
  if Form7.zqry1.Locate('id_pengajuan',e_1.Text,[]) then
  begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tbl_pengajuan values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'")');
 zqry1.ExecSQL ;

 zqry1.SQL.Clear;
 zqry1.SQL.Add('select * from tbl_pengajuan');
 zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_pengajuan set nm_pemohon="'+e_2.Text+'",pekerjaan="'+e_3.Text+'",alamat="'+e_4.Text+'",status_pengajuan="'+e_5.Text+'" where id_pengajuan="'+id_pengajuan+'"');
zqry1. ExecSQL;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_pengajuan where id_pengajuan="'+id_pengajuan+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_pengajuan');
zqry1.Open;
...
begin
id_pengajuan:= zqry1.Fields[0].AsString;
