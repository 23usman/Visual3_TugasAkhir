...
if e_1.Text='' then
  begin
    ...
    if e_2.Text=''then
    begin
     ShowMessage('NAMA KEPERLUAN BELUM DIISI DENGAN BENAR');
    end else
    if e_3.text=''then
    begin
 ...
 zqry1.SQL.Clear;
zqry1.SQL.Add('insert into tbl_layanan values("'+e_1.Text+'","'+e_2.Text+'","'+e_3.Text+'","'+e_4.Text+'","'+e_5.Text+'")');
 zqry1.ExecSQL ;

 zqry1.SQL.Clear;
 zqry1.SQL.Add('select * from tbl_layanan');
 zqry1.Open;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tbl_layanan set nm_keperluan="'+e_2.Text+'",jlh="'+e_3.Text+'",status="'+e_4.Text+'",keterangan="'+e_5.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
procedure TForm13.b4Click(Sender: TObject);
begin
if MessageDlg('APAKAH YAKIN MENGHAPUS DATA INI?',mtWarning,[mbYes,mbNo],0)= mryes then
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from tbl_layanan where id="'+id+'"');
zqry1. ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from tbl_layanan');
zqry1.Open;
...
procedure TForm13.b5Click(Sender: TObject);
begin
posisiawal;
end;
...
procedure TForm13.b6Click(Sender: TObject);
begin
